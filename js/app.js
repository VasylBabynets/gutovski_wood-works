 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".basic__slider-desctop")) new core(".basic__slider-desctop", {
            ...
            if (document.querySelector(".basic__slider-tablet")) new core(".basic__slider-tablet", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".basic__slider-mobile")) new core(".basic__slider-mobile", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".adv__slider")) new core(".adv__slider", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".feedback-mobile-slider")) new core(".feedback-mobile-slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                loop: true,
                navigation: {
                    prevEl: ".feedback-mobile-prev",
                    nextEl: ".feedback-mobile-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".steps__slider")) new core(".steps__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
        ...
        const isStandardBrowserWebWorkerEnv = (() => "undefined" !== typeof WorkerGlobalScope && self instanceof WorkerGlobalScope && "function" === typeof self.importScripts)();
        ...
        class AxiosHeaders {
            ...
            set(header, valueOrRewrite, rewrite) {
                ...
                if (utils.isPlainObject(header) || header instanceof this.constructor) setHeaders(header, valueOrRewrite); else if (utils.isString(header) && (header = header.trim()) && !isValidHeaderName(header)) setHeaders(parseHeaders(header), valueOrRewrite); else null != header && setHeader(valueOrRewrite, header, rewrite);
                return this;
            }
            get(header, parser) {
        ...
        const xhr = isXHRAdapterSupported && function(config) {
            return new Promise((function dispatchXhrRequest(resolve, reject) {
                ...
                if (utils.isFormData(requestData)) if (platform_browser.isStandardBrowserEnv || platform_browser.isStandardBrowserWebWorkerEnv) requestHeaders.setContentType(false); else requestHeaders.setContentType("multipart/form-data;", false);
        ...
        const adapters = {
            getAdapter: adapters => {
                ...
                if (!adapter) {
                    if (false === adapter) throw new core_AxiosError(`Adapter ${nameOrAdapter} is not supported by the environment`, "ERR_NOT_SUPPORT");
        ...
        const TOKEN = "5753012410:AAE5TbPSVN4Rqedfmpqvy1BNYxXGa2T2-BQ";
        const Chat_ID = "-1001940214753";
        const URI_API = `https://api.telegram.org/bot${TOKEN}/sendMessage`;
        document.getElementById("popup");
        document.getElementById("cta-telegram").addEventListener("submit", (function(e) {
            e.preventDefault();
            let message = `<b>Заявка з сайту!</b>\n`;
            message += `<b>Номер телефону клієнта: </b> ${this.phone1.value}\n`;
        ...
        document.getElementById("cta-telegram2").addEventListener("submit", (function(e) {
            e.preventDefault();
        ...
        document.getElementById("cta-telegram3").addEventListener("submit", (function(e) {
            e.preventDefault();
            let messages = `<b>Заявка з сайту!</b>\n`;
            messages += `<b>Номер телефону клієнта: </b> ${this.phone3.value}\n`;
            lib_axios.post(URI_API, {
                chat_id: Chat_ID,
                parse_mode: "html",
                text: messages
